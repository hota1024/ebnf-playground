...
function PlaygroundWithLocalStorage() {
  ...
  return <Playground grammar={grammar} input={input} setGrammar={setGrammar} setInput={setInput} />;
}

function PlaygroundWithQueryParams() {
  const [grammar, setGrammar] = useQueryState("grammar", parseAsString.withDefault(""))
